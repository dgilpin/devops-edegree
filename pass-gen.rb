...
#
#Generates a (somewhat) random password
...
desired_length = gets.chop.to_i

#verify input is within range
if [8,12,16,24,32].count(desired_length) == 0 then
    password_length = 8 #default value of 8 character password
